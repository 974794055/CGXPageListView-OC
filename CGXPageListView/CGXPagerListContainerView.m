...
@interface CGXPagerListContainerView() <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
@property (nonatomic, strong) CGXPagerListContainerCollectionView *collectionView;
@property (nonatomic, strong) NSIndexPath *selectedIndexPath;
@end

@implementation CGXPagerListContainerView

- (instancetype)initWithDelegate:(id<CGXPagerListContainerViewDelegate>)delegate {
...
- (void)initializeViews {
    ...
    _collectionView = [[CGXPagerListContainerCollectionView alloc] initWithFrame:CGRectZero collectionViewLayout:layout];
...
@interface CGXPagerListContainerCollectionView ()

@end

@implementation CGXPagerListContainerCollectionView
